...
class Bug2():
    def __init__(self):
        ...
        self.waypoints = [Point(5.0,0.0,0.0),
                         Point(5.0,4.0,0.0),
                         Point(7.5,-2.0,0.0),
                         Point(3.0, -1.5,0.0),
                         Point(3.0, 2.0, 0.0),
        ...
        self.current_wp = 0
        self.wall_dist = 0.30    # follow wall distance
        ...
        self.line_thresh = 0.1 # distance threshold for checking if close to line
    ...
    def reactive_navigation(self):
        ...
        print('state:%d'%self.state,'dah_left:%.3f'%distance_ahead_left,'dah_right:%.3f'%distance_ahead_right,'side: ' + self.side,'d_ahead:%.2f'%distance_ahead)
        print(self.goal)
        ...
        msg.angular.z = np.arctan2(np.sin(msg.angular.z), np.cos(msg.angular.z)) #Confinar angulo 
